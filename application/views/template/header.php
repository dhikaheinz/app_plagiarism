...
<html>
    ...
    <!-- nav -->
  <nav
			class="fixed left-0 top-0 w-full p-3 bg-gradient-to-r from-[#3462a0] to-[#cdf3f6] shadow md:shadow-md md:flex md:items-center md:justify-between md:px-[100px] transition-all"
		>
			...
			<a href="<?= base_url() ?>" class="text-xl text-white font-semibold hover:text-black">
				<li class="px-4 py-3 md:my-0 hover:bg-[#3462a0] h-full rounded-md">
				Home
				</li>
			</a>
