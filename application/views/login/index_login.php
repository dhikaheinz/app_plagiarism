        ...
        <!-- Login Form -->
			<div class="logo flex items-center justify-center flex-col">
				...
				<div class="px-8 py-6 text-left bg-white shadow-lg rounded-lg">
					<h3 class="text-2xl font-bold text-center text-sky-700">Uji Plagiarism Poltekkes</h3>
					...
					<form action="<?php echo site_url('User/aksi_login'); ?>" method="post">
						<div class="mt-4">
							<div>
								<label class="block text-slate-600" for="username">NIP/NIM<label>
							...
							<div>
								<button type="submit" class="w-full py-2 mt-5 text-white bg-[#3462a0] rounded-md hover:bg-slate-500 shadow-md">Login</button>
							</div>
						</div>
					</form>
				</div>
